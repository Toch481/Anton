...
parcela = re.compile(r'Parcelní číslo:\d?\d?\d?\d?\d?\d?\d?\d?\d?\d?\d?\S?\d?\d?\d?\d?')
obec = re.compile(r'Obec:\w?\w?\w?\w?\w?\w?\w?\w?\w?\w?\w?')
katastr = re.compile(r'Katastrální území:\w?\w?\w?\w?\w?\w?\w?\w?\w?\w?\w?')
lvcislo = re.compile(r'LV:\d?\d?\d?\d?\d?\d?\d?\d?\d?\d?\d?')
# výměra nák zlobí kvuli tomu [m2]
# vymera = re.compile(r'Výměra :\d?\d?\d?\d?\d?\d?\d?\d?\d?\d?\d?')
druhpozemku = re.compile(r'Druh pozemku:\w?\w?\w?\w?\w?\w?\w?\w?\w?\w?\w?')
